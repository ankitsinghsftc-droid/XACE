...
This makes hot-reload deterministic across multiplayer sessions:
    ...
    Host reloads mesh → SHA-256 = "a3f2bc7d..."
    Host broadcasts reload event with hash "a3f2bc7d..."
    All peers reload → same file bytes → same SHA-256 → same version string
    → All AssetReferences.version update to the same value
