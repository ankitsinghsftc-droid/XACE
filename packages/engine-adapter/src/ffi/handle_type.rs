...
use super::shared_buffer::{SharedDeltaBuffer, InputQueue};
...
impl FfiWorldHandle {
    pub fn new(world_seed: u64, delta_buf_bytes: u32) -> Self {
        Self {
            ...
            tick_number:    0,
            world_hash:     "0000000000000000".to_string(),
    ...
    pub fn write_last_error(&self, buffer: *mut i8, buf_size: u32) -> u32 {
        ...
        let msg   = if self.last_error.is_empty() { "no error" } else { &self.last_error };
